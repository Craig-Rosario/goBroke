            ...
            <div class="addIncomeFormCard">
                ...
                <form method="POST" action="index.php">
                    ...
                    <div class="incomeAmt">
                        ...
                        <input type="number" id="incomeAmt" name="income_amount" placeholder="Enter Amount" required>
                    </div>
                    ...
                    <div class="incomeCat">
                        ...
                        <input type="text" id="incomeCat" name="income_category" placeholder="Enter Category" required>
                    </div>
